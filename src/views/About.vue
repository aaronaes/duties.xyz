  ...
  <transition appear>
    <main id="about">
      ...
      <section class="grid-container content-block intro">
        <figure class="grid-x grid-margin-x grid-padding-x align-center">
          <div class="cell small-12 medium-10 large-8 box" v-in-viewport>
            <h2>Studio</h2>
            <h3 class="markdown" v-html="getMarkdown(about.aboutUs)"></h3>
          </div>
        </figure>
      </section>
        ...
        <figure class="grid-x grid-margin-x grid-padding-x align-center">
          <div class="cell small-12 medium-10 large-8 box" v-in-viewport>
            <div v-for="block in about.services" :key="block.id">
              <p class="subtitle">{{ block.title }}</p>
      ...
      <section class="grid-container content-block marquee">
        <figure class="grid-x grid-margin-x grid-padding-x">
          <h3 class="cell shrink box" v-in-viewport>
      ...
      <section class="grid-container content-block summary">
        <figure class="grid-x grid-margin-x grid-padding-x align-center">
          ...
          <div class="cell small-12 medium-10 large-8 footer box" v-in-viewport>
